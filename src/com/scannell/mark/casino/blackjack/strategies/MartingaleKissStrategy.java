...
public class MartingaleKissStrategy extends BlackjackStrategyDecorator {
    ...
    public MartingaleKissStrategy(BlackjackStrategy blackjackStrategy, int initialBetSize, int maxBetSize) {
